...
var Extractor = require("./ChoTotExtractor");
...
DBCache.loadAdsRaw( " and source = 'chotot'", () => {
  ...
  /*
  bdsEx.extractFromTo("https://m.chotot.com/tp-ho-chi-minh/mua-ban-bat-dong-san", 1, 200, () => {
    console.log("Completed!");
    process.exit(0);
  });
  */

  bdsEx.extractFromTo("https://m.chotot.com/ha-noi/mua-ban-bat-dong-san", 100, 10000, () => {
    console.log("Completed!");
    process.exit(0);
  });
